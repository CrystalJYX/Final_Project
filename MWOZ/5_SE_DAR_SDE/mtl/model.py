...
class SE_DAR_SDE(nn.Module):
    def __init__(self, args, vocab_size, class_num, pretrained_private=None, pretrained_encoder=None):
        ...
        if pretrained_encoder is not None:
            ...
            self.encoder = TransformerEncoder(d_model, d_model*2, 8, 2, 0.2)
    ...
    def forward(self, input_ids, act_seq=None, sat_diff=None, sat=None, **kwargs):
        ...
        if self.training:
            ...
            weight_class2 = torch.FloatTensor([235.34782608695653,8.340523882896765,1.0,7.466206896551724,284.89473684210526]).cuda()
