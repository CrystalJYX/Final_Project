...
class SE_DAR_DSR(nn.Module):
    def __init__(self, args, vocab_size, class_num, pretrained_private=None, pretrained_encoder=None):
        ...
        self.sat_seq_gru = nn.GRU(5, d_model, num_layers=2, bidirectional=False, batch_first=True)
    ...
    def forward(self, input_ids, act_seq=None,sat_seq=None, sat=None, **kwargs):
        ...
        if self.training:
            ...
            weight_class1 = torch.FloatTensor([664.2222222222222, 13.617312072892938, 1.0, 14.982456140350877, 1494.5]).cuda()
